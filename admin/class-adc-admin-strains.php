...
class ADC_Admin_Strains {
    ...
    public function render_strains() {
        $strains = ADC_Strains::get_all(array('active_only' => false, 'orderby' => 'name'));
    ...
    public function render_strain_form() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['adc_strain_nonce'])) {
            if (!wp_verify_nonce($_POST['adc_strain_nonce'], 'adc_save_strain')) {
            ...
            $data = array(
                ...
                'baeocystin' => absint($_POST['baeocystin']),
                'norbaeocystin' => absint($_POST['norbaeocystin']),
                'aeruginascin' => absint($_POST['aeruginascin']),
