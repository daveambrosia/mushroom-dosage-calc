...
class ADC_Admin {
	...
	private function __construct() {
		...
		add_action( 'admin_init', array( $this, 'add_security_headers' ) );  // BUG-015 fix
	}
	 ...
	 *
	 * @since 2.18.0
	 * @since 2.22.0 Added Content-Security-Policy
	 */
	public function add_security_headers() {
		...
		if ( $screen && strpos( $screen->id, 'dosage-calculator' ) !== false ) {
			...
			// Content Security Policy - allow self + inline styles/scripts (needed for WordPress admin)
	...
	public function render_dashboard() {
		...
		<div class="wrap adc-admin">
			<h1>Dosage Calculator v<?php echo esc_html( ADC_VERSION ); ?></h1>
			...
			<div class="adc-shortcode-help">
				...
				<code>[dosage_calculator_qr_maker]</code>
				<p class="description">
