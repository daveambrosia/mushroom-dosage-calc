...
class ADC_Submissions {
    ...
    public static function create($data) {
        ...
        // Sanitize
        $insert_data = array(
            'type' => in_array($data['type'], array('strain', 'edible')) ? $data['type'] : 'strain',
            'source' => in_array($data['source'], array('user_submit', 'qr_scan', 'unknown')) ? $data['source'] : 'user_submit',
    ...
    public static function approve($id, $admin_notes = '') {
        ...
        $data['notes'] = sprintf("User submitted by %s (%s)\n%s", 
