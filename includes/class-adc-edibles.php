...
class ADC_Edibles {
    ...
    public static function get_all($args = array()) {
        ...
        $cache_key = self::cache_prefix() . 'all_'
            ...
            . ($args['brand'] ?: '-') . '_'
            . ($args['search'] ?: '-') . '_'
            . ($args['min_potency'] !== null ? $args['min_potency'] : '-') . '_'
            . ($args['max_potency'] !== null ? $args['max_potency'] : '-');
        ...
        if ($args['use_cache'] && $args['active_only'] && $args['limit'] === 0) {
    ...
    /**
     * Clear edibles cache (call after create/update/delete)
     */
    /**
