...
class ADC_Activator {
	...
	private static function set_default_options() {
		$defaults = array(
			...
			'calculator_title'              => '🍄 Psilocybin Dosage Calculator',
			'calculator_subtitle'           => 'Psilocybin Dosage Calculator: For use with lab-tested mushrooms and edibles. Every mushroom is different; even ones growing side by side can be twice as strong as the other. Lab tests show some can be up to 80 times stronger than others. Strength depends on the strain, the grower, what they\'re grown on, how they\'re dried, and how they\'re stored.',
			'safety_items'                  => '<ul><li><strong>DO NOT</strong> drive or operate heavy machinery</li><li><strong>DO NOT</strong> mix with alcohol</li><li>RESEARCH all medications before use</li><li><strong>DO NOT</strong> take if you have heart problems</li></ul>',
