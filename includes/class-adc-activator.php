...
class ADC_Activator {
    ...
    private static function insert_default_data() {
        ...
        if ($cat_count == 0) {
            $categories = array(
                array('name' => 'Lab Tested', 'slug' => 'lab-tested', 'type' => 'both', 'sort_order' => 1),
                array('name' => 'House Strain', 'slug' => 'house-strain', 'type' => 'strain', 'sort_order' => 2),
                array('name' => 'Community', 'slug' => 'community', 'type' => 'both', 'sort_order' => 3),
                array('name' => 'Psilocybe cubensis', 'slug' => 'psilocybe-cubensis', 'type' => 'strain', 'sort_order' => 10),
                array('name' => 'Psilocybe cyanescens', 'slug' => 'psilocybe-cyanescens', 'type' => 'strain', 'sort_order' => 11),
                array('name' => 'Panaeolus cyanescens', 'slug' => 'panaeolus-cyanescens', 'type' => 'strain', 'sort_order' => 12),
                array('name' => 'Standard Potency', 'slug' => 'standard-potency', 'type' => 'strain', 'sort_order' => 20),
                array('name' => 'Moderate Potency', 'slug' => 'moderate-potency', 'type' => 'strain', 'sort_order' => 21),
                array('name' => 'High Potency', 'slug' => 'high-potency', 'type' => 'strain', 'sort_order' => 22),
                array('name' => 'Very High Potency', 'slug' => 'very-high-potency', 'type' => 'strain', 'sort_order' => 23),
            );
        ...
        if ($type_table) {
            ...
            if ($type_count == 0) {
                $product_types = array(
                    array('name' => 'Chocolate', 'slug' => 'chocolate', 'sort_order' => 1),
                    array('name' => 'Gummy', 'slug' => 'gummy', 'sort_order' => 2),
                    array('name' => 'Capsule', 'slug' => 'capsule', 'sort_order' => 3),
                    array('name' => 'Tea', 'slug' => 'tea', 'sort_order' => 4),
                    array('name' => 'Tincture', 'slug' => 'tincture', 'sort_order' => 5),
                    array('name' => 'Other', 'slug' => 'other', 'sort_order' => 99),
                );
        ...
        if ($comp_table) {
            ...
            if ($comp_count == 0) {
                $compounds = array(
                    array('compound_key' => 'psilocybin', 'display_name' => 'Psilocybin', 'unit' => 'mcg/g', 'affects_dosing' => 1, 'calculation_weight' => 1.00, 'sort_order' => 1),
                    array('compound_key' => 'psilocin', 'display_name' => 'Psilocin', 'unit' => 'mcg/g', 'affects_dosing' => 1, 'calculation_weight' => 1.00, 'sort_order' => 2),
                    array('compound_key' => 'norpsilocin', 'display_name' => 'Norpsilocin', 'unit' => 'mcg/g', 'affects_dosing' => 0, 'calculation_weight' => 0.00, 'sort_order' => 3),
                    array('compound_key' => 'baeocystin', 'display_name' => 'Baeocystin', 'unit' => 'mcg/g', 'affects_dosing' => 0, 'calculation_weight' => 0.00, 'sort_order' => 4),
                    array('compound_key' => 'norbaeocystin', 'display_name' => 'Norbaeocystin', 'unit' => 'mcg/g', 'affects_dosing' => 0, 'calculation_weight' => 0.00, 'sort_order' => 5),
                    array('compound_key' => 'aeruginascin', 'display_name' => 'Aeruginascin', 'unit' => 'mcg/g', 'affects_dosing' => 0, 'calculation_weight' => 0.00, 'sort_order' => 6),
                );
        ...
        if ($strain_table) {
            ...
            if ($strain_count == 0) {
                $strains = array(
                    array('short_code' => 'ZD-GT-001', 'name' => 'Golden Teacher', 'category' => 'standard-potency', 'psilocybin' => 6200, 'psilocin' => 800),
                    array('short_code' => 'ZD-BP-001', 'name' => 'B+', 'category' => 'standard-potency', 'psilocybin' => 7000, 'psilocin' => 0),
                    array('short_code' => 'ZD-PE-001', 'name' => 'Penis Envy', 'category' => 'high-potency', 'psilocybin' => 12000, 'psilocin' => 3000),
                    array('short_code' => 'ZD-APE-001', 'name' => 'Albino Penis Envy', 'category' => 'high-potency', 'psilocybin' => 18000, 'psilocin' => 0),
                    array('short_code' => 'ZD-EN-001', 'name' => 'Enigma', 'category' => 'very-high-potency', 'psilocybin' => 18000, 'psilocin' => 4000),
                );
    ...
    private static function maybe_migrate_data() {
        ...
        if ($columns && !in_array('is_active', $columns)) {
        ...
        if ($pt_columns && !in_array('unit_name', $pt_columns)) {
