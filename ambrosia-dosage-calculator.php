...
window.addEventListener('message', function(e) {
    ...
    // Build CSS: override --adc-* vars on #adc-calculator
    var css = '#adc-calculator {\n';
    var vars = data.vars || {};
    ...
    // Also update data-template if provided
    if (data.template) {
        var calc = document.getElementById('adc-calculator');
        if (calc) {
            calc.setAttribute('data-template', data.template);
        }
    }
});
...
<?php
    ...
    public function enqueue_public_assets() {
        ...
        $template = ADC_DB::get_setting('template', 'brutal');
        ...
        // Pass data to JS
        wp_localize_script('adc-calculator', 'adcData', array(
